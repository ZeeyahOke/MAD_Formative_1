        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                _buildRiskBox('${attendance.toStringAsFixed(0)}%', AppColors.danger, 'Attendance'),
                const SizedBox(width: 16),
                _buildRiskBox('60%', AppColors.accentYellow, 'Assignment to\nStlamment'), // Dummy static for now as no logic defined
                const SizedBox(width: 16),
                _buildRiskBox('63%', AppColors.danger, 'Average\nExsite'), // Dummy static
              ],
            ),
